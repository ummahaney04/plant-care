...
import { useUser } from "../components/context/UserContext"; // login check
...
export default function AllCategory() {
  ...
  const { user } = useUser(); // check user login
          ...
          >
            ...
            <div className="p-4 text-center">
              ...
              <button
                ...
                className="mt-3 bg-[#007b3e] hover:bg-[#00a63e] text-white px-4 py-2 rounded-xl w-full active:scale-95 transition-transform duration-300"
              >
                Add to Cart
              </button>
            </div>
